...
class Dataset():
    ...
    def read_partitions(self):
        ...
        self.dataset = getattr(self, "_{}".format(self.name))()
    ...
    def _bentham(self):
        ...
        for i in self.partitions:
            ...
            for line in paths[i]:
                dataset[i]['dt'].append(os.path.join(img_path, "{}.png".format(line)))
    ...
    def _iam(self):
        ...
        for i in self.partitions:
            ...
            for line in paths[i]:
                try:
                    split = line.split("-")
                    folder = "{}-{}".format(split[0], split[1])

                    img_file = "{}-{}-{}.png".format(split[0], split[1], split[2])
    ...
    def _saintgall(self):
        ...
        for i in self.partitions:
            ...
            for line in paths[i]:
                glob_filter = os.path.join(img_path, "{}*".format(line))
